...
LOG_DIR='logs'
LOG_ALIAS='train_wpdc'
LOG_FILE=LOG_DIR+'/'+time.strftime('%Y-%m-%d-%H-%M-%S', time.localtime(time.time()))+'.log'
...
def parse_args():
    ...
    parser.add_argument('--filelists-train',
                        default='../train.configs/train_aug_120x120.list.train', type=str)
    parser.add_argument('--filelists-val',
                        default='../train.configs/train_aug_120x120.list.val', type=str)
    parser.add_argument('--root', default='./train_aug_120x120')
    parser.add_argument('--snapshot', default='snapshot/phase1_wpdc', type=str)
    ...
    parser.add_argument('--param-fp-train',
                        default='../train.configs/param_all_norm.pkl',
                        type=str)
    parser.add_argument('--param-fp-val',
                        default='../train.configs/param_all_norm_val.pkl')
...
def train(train_loader, model, criterion, optimizer, epoch):
    ...
    model.train()  #﻿Cascaded Regression !
